	...
	$.extend(Plugin.prototype, {
		...
		initSlideshow: function () {
			...
			if (this.support) {
				...
				setTimeout(function(){
					$firstSlide.css( { 'opacity': 1.0, 'transform': 'scale(1.15, 1.15)', 'z-index': 2 } );
					$('.ltx-zs-slide-0').addClass('visible');
				}, 50);
			}
		...
		initSingle: function() {
			...
			//$('.ltx-zs-slide-'+ this.number +').addClass('visible');
			...
			if (this.support) {
				...
				setTimeout(function(){
					$slide.css( { 'opacity': 1.0, 'transform': 'scale(1.15, 1.15)', 'z-index': 2 } );
				}, 50);
			}
		},
		...
		jump: function( pos ) {
			...
			if ( this.support ) {
				...
				$("[class*='ltx-zs-slide-']").removeClass('visible');
				$('.ltx-zs-slide-'+ pos).addClass('visible');
				//console.log(pos);
				$nowSlide.addClass('active')
					.css( this.transitionProp )
					.css( { 'opacity': 1.0, 'transform': 'scale(1.15, 1.15)', 'z-index': 2 } )
