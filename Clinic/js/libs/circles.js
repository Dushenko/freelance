  ...
  Circles.prototype = {
    ...
    htmlifyNumber: function(number, integerPartClass, decimalPartClass) {
      ...
      var parts = (number + '').split('.'),
          html  = '<h2 class="header"><span class="countUp">' + parts[0] +'</span>%</h2><h4 class="subheader">' + this._textname + '</h4>';
                              //<h4 class="subheader">Болезни печени</h4>
                            //</div><span class="' + integerPartClass + '">''</span>';
